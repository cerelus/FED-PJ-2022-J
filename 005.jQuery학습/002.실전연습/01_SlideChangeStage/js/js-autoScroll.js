...
function loadFn(){ // 선언적함수 -> 호출이 위에 자리해도 상관없음
    ...
    /******************************************************
        ...
        (3) passive: 스크롤 성능 향상을 위한 옵션으로 true일 경우, 
                ...
                -> 최근 업데이트 된 브라우저는 passive기본값이 true로 셋팅됨으로
                window, document, body 이 세가지 객체에 대해 스크롤 막기기능을 비활성화 하였다!
                따라서 기본기능을 막고자 하면 passiv:false로 기능을 활성화 해야한다!
    ...
    ******************************************************/
    ...
    // 1. 전체 휠 이벤트 설정하기 /////
    window.addEventListener("wheel",wheelFn,{passive:false}); // {} : 객체
